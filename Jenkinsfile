pipeline {
  agent any
  environment {
    PIPELINE_USER_CREDENTIAL_ID = 'AKIA2MMIEN3L7PUMUFOU'
    SAM_TEMPLATE = 'sam-app/template.yaml'
    MAIN_BRANCH = 'main'
    TESTING_STACK_NAME = 'dev'
    TESTING_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::713786945239:role/aws-sam-cli-managed-dev-pipe-PipelineExecutionRole-PH0W1EL17TXA'
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::713786945239:role/aws-sam-cli-managed-dev-p-CloudFormationExecutionR-19TLJOXGBOKQA'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-artifactsbucket-1ml31jeo1dljq'
    ...
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::713786945239:role/aws-sam-cli-managed-prod-pip-PipelineExecutionRole-J8ADEPDRHMHD'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::713786945239:role/aws-sam-cli-managed-prod-CloudFormationExecutionR-1A7YLNANVAXSN'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-prod-pipeline-artifactsbucket-y0jhdglbpmr9'
    // If there are functions with "Image" PackageType in your template,
